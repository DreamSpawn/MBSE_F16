 ...
 * @generated
 */
public class YAWL_netSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case YAWL_netPackage.YAWL_NET_TYPE: {
				YAWL_NetType yawL_NetType = (YAWL_NetType)theEObject;
				T result = caseYAWL_NetType(yawL_NetType);
				if (result == null) result = casePetriNetType(yawL_NetType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case YAWL_netPackage.TRANSITION: {
			...
			case YAWL_netPackage.PLACE_TYPE: {
			...
			case YAWL_netPackage.TRANSITION_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>YAWL Net Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>YAWL Net Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseYAWL_NetType(YAWL_NetType object) {
		return null;
	}
