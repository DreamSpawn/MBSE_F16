...
public class YAWL_netPackageImpl extends EPackageImpl implements YAWL_netPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTransitionType_Text(), this.getTransitionTypes(), "text", null, 1, 1, TransitionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
