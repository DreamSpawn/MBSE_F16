 ...
 * </p>
 * <ul>
 *   <li>{@link yawl_net.impl.ArcTypeImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArcTypeImpl extends AttributeImpl implements ArcType {
	...
	protected EClass eStaticClass() {
		return YAWL_netPackage.Literals.ARC_TYPE;
	}
	...
	public void setText(ArcTypes newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YAWL_netPackage.ARC_TYPE__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YAWL_netPackage.ARC_TYPE__TEXT:
				return getText();
		}
